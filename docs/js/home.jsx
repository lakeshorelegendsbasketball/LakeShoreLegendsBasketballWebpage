    ...
    <section className="lsl-section lsl-section--cream">
      <div className="lsl-wrap lsl-philosophy">
        ...
        <div>
          ...
          <p className="lsl-pullquote" style={{ marginTop: '20px', textAlign: 'center' }}>&ldquo;We don&rsquo;t just play the game&hellip;<br/>We study it.&rdquo;</p>
        </div>
      </div>
    </section>
  );
  ...
  return (
    <section className="lsl-section lsl-section--cream">
      <div className="lsl-wrap lsl-philosophy">
        ...
        <div>
          <SectionHead wide title={<>Basketball IQ<br/>&amp; Game Mastery</>} />
